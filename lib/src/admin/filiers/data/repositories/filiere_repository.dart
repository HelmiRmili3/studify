...
class FiliereRepository extends StorageRepository {
  final FirebaseFirestore _firebaseFirestore = FirebaseFirestore.instance;
  ...
  Future<void> addFiliere(NewFiliere filiere, File? image) async {
    try {
      // Upload image and get metadata
      FileEntity fileMetadata = await uploadFile(image!, 'images');
      ...
      for (int niveau = 1; niveau <= filiere.nbYears; niveau++) {
        ...
        await niveauDocRef.set({
          ...
          'nbYears': filiere.nbYears,
          "year": niveau,
          "imageUrl": fileMetadata.filename,
        ...
        await _firebaseFirestore
            ...
            .collection(Firestore.filieres)
            .doc(filiere.code)
            .set(filiere.copyWith(image: fileMetadata.filepath).toJson());
      }
  ...
  Future<void> deleteFiliere(String code) async {
    try {
      ...
      debugPrint("Error deleting filiere: $e");
    }
  }
}
